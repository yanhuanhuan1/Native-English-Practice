  ...
  return [
    {
      ...
      content: [
        ...
        "- Prefer the selected YouTube reserve video when it is present.",
        "- Use official or high-quality media sources first: BBC Learning English, British Council LearnEnglish, VOA Learning English, TED, TED-Ed, BBC World Service, WSJ, or DW.",
        "- If the reserve item is a YouTube video, keep its url, embedUrl, source, title, duration, and playerType unless the link is invalid.",
        "- Official media web pages are the next fallback.",
        "- Bilibili is the last fallback only.",
